...
$\color{#EFEEEE}{\textsf{ мιcнαєℓ }}$ $\color{#47B1E9}{\textsf{∂є ѕαηтα }}$ $\color{#2D2D2D}{\textsf{уυмє }}$ 
...
$\color{#EFEEEE}{\textsf{ c+н єηc }}$ $\color{#47B1E9}{\textsf{ωнєη }}$ $\color{#2D2D2D}{\textsf{αℓσηє }}$
